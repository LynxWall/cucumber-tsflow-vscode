...
export async function runFakeTests(controller: vscode.TestController, request: vscode.TestRunRequest): Promise<void> {
...
async function runNode(node: vscode.TestItem, request: vscode.TestRunRequest, run: vscode.TestRun): Promise<void> {
